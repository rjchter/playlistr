import { PDFViewer, View, Page as PDFPage, Text, Image, Document } from "@react-pdf/renderer";
...
function PdfCards({ playlistItems, name }: PdfCardsProps) {
    ...
    return (
        <PDFViewer style={{ display: "flex", width: "100%", height: 800, flexGrow: 1, marginTop: "2rem" }}>
            <Document>
